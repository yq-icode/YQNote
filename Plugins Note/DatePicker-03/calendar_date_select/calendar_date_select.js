  ...
  refreshCalendarGrid: function () {
    ...
    for (var cell_index = 0;cell_index<42; cell_index++)
    {
      ...
      cell.day = day; cell.month = month; cell.year = iterator.getFullYear();
	   //console.log($F('start_id'))
	   //console.log(Date.parseFormattedString($F('start_id')))
	   //console.log(iterator.stripTime() >= Date.parseFormattedString($F('start_id')))
...
//	if (this.target_element.type != "hidden" && ! this.target_element.disabled) this.target_element.next.focus();
	if (this.target_element.type != "hidden" && ! this.target_element.disabled) this.target_element.blur();
