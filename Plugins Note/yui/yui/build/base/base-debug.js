...
}, '3.3.0pr1' ,{requires:['attribute-base']});
...
}, '3.3.0pr1' ,{requires:['base-base', 'pluginhost']});
...
}, '3.3.0pr1' ,{requires:['base-base']});


YUI.add('base', function(Y){}, '3.3.0pr1' ,{after:['attribute-complex'], use:['base-base', 'base-pluginhost', 'base-build']});
