...
}, '3.3.0pr1' ,{requires:['datasource-local', 'io']});
...
}, '3.3.0pr1' ,{requires:['datasource-local', 'get']});
...
}, '3.3.0pr1' ,{requires:['datasource-local']});
...
}, '3.3.0pr1' ,{requires:['plugin', 'datasource-local', 'dataschema-json']});
...
}, '3.3.0pr1' ,{requires:['plugin', 'datasource-local', 'dataschema-xml']});
...
}, '3.3.0pr1' ,{requires:['plugin', 'datasource-local', 'dataschema-array']});
...
}, '3.3.0pr1' ,{requires:['plugin', 'datasource-local', 'dataschema-text']});
...
YUI.add('datasource', function(Y){}, '3.3.0pr1' ,{use:['datasource-local','datasource-io','datasource-get','datasource-function','datasource-cache','datasource-jsonschema','datasource-xmlschema','datasource-arrayschema','datasource-textschema','datasource-polling']});
