...
}, '3.3.0pr1' ,{requires:['base','record','arraylist']});
...
}, '3.3.0pr1' ,{requires:['recordset-base','arraysort','plugin']});
...
}, '3.3.0pr1' ,{requires:['recordset-base','plugin']});


YUI.add('recordset', function(Y){}, '3.3.0pr1' ,{use:['recordset-base','recordset-sort','recordset-filter','recordset-indexer']});
