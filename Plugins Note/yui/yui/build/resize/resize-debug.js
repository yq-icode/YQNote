...
}, '3.3.0pr1' ,{requires:['base', 'widget', 'substitute', 'event', 'oop', 'dd-drag', 'dd-delegate', 'dd-drop'], skinnable:true});
...
}, '3.3.0pr1' ,{requires:['resize-base', 'plugin'], skinnable:false});
...
YUI.add('resize', function(Y){}, '3.3.0pr1' ,{use:['resize-base', 'resize-proxy', 'resize-constrain']});
