...
}, '3.3.0pr1' ,{optional:['jsonp', 'yql'], requires:['array-extras', 'base-build', 'event-valuechange', 'node-base']});
...
}, '3.3.0pr1' ,{skinnable:true, requires:['autocomplete-base', 'widget', 'widget-position', 'widget-position-align', 'widget-stack'], lang:['en']});
...
}, '3.3.0pr1' ,{requires:['autocomplete-list', 'node-pluginhost']});


YUI.add('autocomplete', function(Y){}, '3.3.0pr1' ,{use:['autocomplete-base', 'autocomplete-list', 'autocomplete-plugin']});
