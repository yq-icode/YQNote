...
}, '3.3.0pr1' ,{requires:['array-extras', 'escape', 'unicode-wordbreak']});
...
}, '3.3.0pr1' ,{requires:['highlight-base', 'unicode-accentfold']});


YUI.add('highlight', function(Y){}, '3.3.0pr1' ,{use:['highlight-base', 'highlight-accentfold']});
