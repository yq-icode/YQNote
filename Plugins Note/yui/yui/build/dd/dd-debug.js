...
}, '3.3.0pr1' ,{requires:['node', 'base', 'yui-throttle', 'classnamemanager'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['dd-ddm-base', 'event-resize'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['dd-ddm'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['dd-ddm-base'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['dd-ddm', 'dd-drag'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['dd-drag'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['dd-drag'], skinnable:false, optional:['dd-proxy']});
...
}, '3.3.0pr1' ,{requires:['dd-ddm-drop', 'dd-drag'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['dd-drag', 'event-mouseenter'], skinnable:false, optional:['dd-drop-plugin']});


YUI.add('dd', function(Y){}, '3.3.0pr1' ,{skinnable:false, use:['dd-ddm-base', 'dd-ddm', 'dd-ddm-drop', 'dd-drag', 'dd-proxy', 'dd-constrain', 'dd-drop', 'dd-scroll', 'dd-delegate']});
