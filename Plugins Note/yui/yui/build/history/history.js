...
}, '3.3.0pr1' ,{requires:['event-custom-complex']});
...
}, '3.3.0pr1' ,{requires:['event-synthetic', 'history-base', 'yui-later']});
...
}, '3.3.0pr1' ,{requires:['history-hash', 'node-base']});
...
}, '3.3.0pr1' ,{requires:['event-base', 'history-base', 'node-base'], optional:['json']});


YUI.add('history', function(Y){}, '3.3.0pr1' ,{use:['history-base', 'history-hash', 'history-hash-ie', 'history-html5']});
