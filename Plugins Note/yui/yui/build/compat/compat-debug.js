...
Y.register("yahoo", Y, {version: "3.3.0pr1", build: "10"});
...
Y.register("event", Y.util.Event, {version: "3.3.0pr1", build: "10"});
...
YAHOO.register("dom", YAHOO.util.Dom, {version: "3.3.0pr1", build: "10"});



}, '3.3.0pr1' ,{requires:['dom','dom-style-ie','event-base','dump','substitute']});
