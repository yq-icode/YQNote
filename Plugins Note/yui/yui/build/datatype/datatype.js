...
YUI.add('datatype-number', function(Y){}, '3.3.0pr1' ,{use:['datatype-number-parse', 'datatype-number-format']});
...
YUI.add('datatype-xml', function(Y){}, '3.3.0pr1' ,{use:['datatype-xml-parse', 'datatype-xml-format']});



YUI.add('datatype', function(Y){}, '3.3.0pr1' ,{use:['datatype-number', 'datatype-date', 'datatype-xml']});
