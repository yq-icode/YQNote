...
}, '3.3.0pr1' ,{requires:['attribute', 'event-focus', 'base-base', 'base-pluginhost', 'node-base', 'node-style', 'node-event-delegate', 'classnamemanager']});
...
}, '3.3.0pr1' ,{requires:['widget-base', 'node-event-delegate']});
...
YUI.add('widget', function(Y){}, '3.3.0pr1' ,{use:['widget-base', 'widget-uievents', 'widget-htmlparser', 'widget-skin']});
