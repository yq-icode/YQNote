...
}, '3.3.0pr1' ,{requires:['get','features']});
...
YUI.add('yui', function(Y){}, '3.3.0pr1' ,{use:['yui-base','get','features','rls','intl-base','yui-log','yui-later','yui-throttle']});
...
}, '3.3.0pr1' ,{requires:['dom-base', 'dom-style', 'event-base']});
...
}, '3.3.0pr1' ,{requires:['selector-native']});


YUI.add('selector', function(Y){}, '3.3.0pr1' ,{use:['selector-native', 'selector-css2']});



YUI.add('dom', function(Y){}, '3.3.0pr1' ,{use:['dom-base', 'dom-style', 'dom-screen', 'selector']});
...
}, '3.3.0pr1' ,{requires:['event-custom-base']});
...
}, '3.3.0pr1' ,{requires:['pluginhost-base']});


YUI.add('pluginhost', function(Y){}, '3.3.0pr1' ,{use:['pluginhost-base', 'pluginhost-config']});
...
}, '3.3.0pr1' ,{requires:['dom-base', 'selector-css2', 'event-base']});
...
}, '3.3.0pr1' ,{requires:['dom-style', 'node-base']});
...
}, '3.3.0pr1' ,{requires:['node-base', 'pluginhost']});
...
}, '3.3.0pr1' ,{requires:['node-base', 'event-delegate']});


YUI.add('node', function(Y){}, '3.3.0pr1' ,{requires:['dom', 'event-base', 'event-delegate', 'pluginhost'], use:['node-base', 'node-style', 'node-screen', 'node-pluginhost', 'node-event-delegate'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['event-custom-base', 'querystring-stringify-simple']});
...
}, '3.3.0pr1' ,{requires:['transition-native', 'node-style']});


YUI.add('transition', function(Y){}, '3.3.0pr1' ,{use:['transition-native', 'transition-timer']});
...
}, '3.3.0pr1' ,{requires:['dom-base', 'selector-native', 'selector-css2']});
...
}, '3.3.0pr1' ,{use:['yui','oop','dom','event-custom-base','event-base','pluginhost','node','event-delegate','io-base','json-parse','transition','selector-css3','dom-style-ie']});
var Y = YUI().use('*');
