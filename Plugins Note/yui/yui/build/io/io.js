...
}, '3.3.0pr1' ,{requires:['io-base','node-base']});
...
}, '3.3.0pr1' ,{requires:['io-base','datatype-xml']});
...
}, '3.3.0pr1' ,{requires:['io-base','queue-promote']});



YUI.add('io', function(Y){}, '3.3.0pr1' ,{use:['io-base', 'io-form', 'io-xdr', 'io-upload-iframe', 'io-queue']});
