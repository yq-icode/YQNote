...
}, '3.3.0pr1' ,{requires:['base', 'node', 'selector-css3', 'substitute'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['node'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['frame'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['editor-base'], skinnable:false});
...
}, '3.3.0pr1' ,{requires:['base', 'frame', 'node', 'exec-command', 'selection', 'editor-para'], skinnable:false});
...
YUI.add('editor', function(Y){}, '3.3.0pr1' ,{skinnable:false, use:['frame', 'selection', 'exec-command', 'editor-base', 'editor-para']});
