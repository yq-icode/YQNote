...
}, '3.3.0pr1' ,{requires:['node-base', 'event-custom']});
...
}, '3.3.0pr1' ,{requires:['event-synthetic']});
...
YUI.add('event', function(Y){}, '3.3.0pr1' ,{use:['event-base', 'event-delegate', 'event-synthetic', 'event-mousewheel', 'event-mouseenter', 'event-key', 'event-focus', 'event-resize']});
