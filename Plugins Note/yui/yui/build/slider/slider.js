...
}, '3.3.0pr1' ,{requires:['widget', 'substitute', 'dd-constrain']});
...
}, '3.3.0pr1' ,{requires:['slider-base', 'clickable-rail', 'slider-value-range']});


YUI.add('slider', function(Y){}, '3.3.0pr1' ,{use:['slider-base', 'slider-value-range', 'clickable-rail', 'range-slider']});
