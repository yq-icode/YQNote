...
}, '3.3.0pr1' ,{requires:['intl','substitute','widget','recordset-base'], lang:['en']});
...
}, '3.3.0pr1' ,{lang:['en'], requires:['plugin','datatable-base','recordset-sort']});
...
}, '3.3.0pr1' ,{requires:['plugin','datatable-base','stylesheet']});


YUI.add('datatable', function(Y){}, '3.3.0pr1' ,{use:['datatable-base','datatable-sort','datatable-scroll']});
